    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { type: 'button', className: 'navbar-toggle collapse', 'data-toggle': 'collapse', 'data-target': '#navbar' },
            _react2.default.createElement(
              'span',
              { className: 'sr-only' },
              'Toggle Navigation'
        ...
        _react2.default.createElement(
          'div',
          { id: 'navbar', className: 'navbar-collapse navbar' },
          _react2.default.createElement(
            'ul',
  ...
  _createClass(Helpers, null, [{
    ...
    value: function nodesMovieCard(state, props, toggleCommentsPanel, toggleVotePanel) {
      ...
      nodes.panelToggles = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: 'btn-primary btn', onClick: toggleCommentsPanel },
          state.showCommentsPanel ? 'Hide' : 'Comments'
        ),
        _react2.default.createElement(
          'a',
          { className: 'btn-primary btn', onClick: toggleVotePanel },
      ...
      return new Promise(function (resolve, reject) {
        ...
        $.ajax(request).done(function (tmdbResponse) {
          ...
          if (tmdbResponse.total_results === 0) {
            ...
            resolve({ posterUrl: POSTER_BASE_URL + '/' + posterPath, overview: tmdbResponse.results[0].overview });
          }
        }).fail(function (err) {
          reject({
